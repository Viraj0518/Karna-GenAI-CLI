...
TOOL_CAPABLE_FAMILIES = {
    ...
    "mistral-large", "mistral-nemo", "mixtral", "gemma-3",
    "phi-3.5", "phi-4", "deepseek-v3", "deepseek-r1",
}

VISION_HINTS = (
    "vl", "vision", "multimodal", "image", "llava", "pixtral", "gemma-3",
    "qwen2-vl", "qwen2.5-vl", "qwen3-vl", "pix", "clip", "janus",
)

THINKING_HINTS = (
    "thinking", "o1", "o3", "o4", "deepseek-r1", "qwq", "r1-distill",
    "reasoning",
)
...
DIRECT_MODELS: list[dict[str, Any]] = [
    ...
    {"id": "anthropic/claude-opus-4-7", "provider": "anthropic",
     ...
     "supports_thinking": True, "cost_per_mtok_input": 15.0, "cost_per_mtok_output": 75.0},
    {"id": "anthropic/claude-opus-4-7-1m", "provider": "anthropic",
     "context_window": 1000000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 30.0, "cost_per_mtok_output": 150.0},
    {"id": "anthropic/claude-sonnet-4-6", "provider": "anthropic",
     "context_window": 200000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 3.0, "cost_per_mtok_output": 15.0},
    {"id": "anthropic/claude-haiku-4-5", "provider": "anthropic",
     "context_window": 200000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 1.0, "cost_per_mtok_output": 5.0},
    {"id": "anthropic/claude-opus-4-5", "provider": "anthropic",
     "context_window": 200000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 15.0, "cost_per_mtok_output": 75.0},
    {"id": "anthropic/claude-3-7-sonnet", "provider": "anthropic",
     "context_window": 200000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 3.0, "cost_per_mtok_output": 15.0},
    # OpenAI direct
    {"id": "openai/gpt-5", "provider": "openai",
     "context_window": 400000, "max_output": 16384,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 5.0, "cost_per_mtok_output": 15.0},
    {"id": "openai/gpt-5-mini", "provider": "openai",
     "context_window": 400000, "max_output": 16384,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 0.15, "cost_per_mtok_output": 0.6},
    {"id": "openai/gpt-5-turbo", "provider": "openai",
     "context_window": 200000, "max_output": 16384,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 2.5, "cost_per_mtok_output": 7.5},
    {"id": "openai/gpt-4o", "provider": "openai",
     "context_window": 128000, "max_output": 16384,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 2.5, "cost_per_mtok_output": 10.0},
    {"id": "openai/gpt-4o-mini", "provider": "openai",
     "context_window": 128000, "max_output": 16384,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 0.15, "cost_per_mtok_output": 0.6},
    {"id": "openai/o3", "provider": "openai",
     "context_window": 200000, "max_output": 100000,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 60.0, "cost_per_mtok_output": 240.0},
    {"id": "openai/o3-mini", "provider": "openai",
     "context_window": 200000, "max_output": 100000,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": True, "cost_per_mtok_input": 1.1, "cost_per_mtok_output": 4.4},
    {"id": "openai/o4", "provider": "openai",
     "context_window": 200000, "max_output": 100000,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 15.0, "cost_per_mtok_output": 60.0},
    # Google direct
    {"id": "google/gemini-2.5-pro", "provider": "google",
     "context_window": 2000000, "max_output": 65536,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 2.5, "cost_per_mtok_output": 10.0},
    {"id": "google/gemini-2.5-flash", "provider": "google",
     "context_window": 1000000, "max_output": 65536,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 0.3, "cost_per_mtok_output": 2.5},
    {"id": "google/gemini-2.0-pro", "provider": "google",
     "context_window": 2000000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 1.25, "cost_per_mtok_output": 5.0},
    {"id": "google/gemini-2.0-flash", "provider": "google",
     "context_window": 1000000, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 0.1, "cost_per_mtok_output": 0.4},
    # Local Ollama common library entries
    {"id": "ollama/llama3.3", "provider": "ollama",
     "context_window": 131072, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/llama3.2", "provider": "ollama",
     "context_window": 131072, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/llama3.2-vision", "provider": "ollama",
     "context_window": 131072, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/qwen2.5-coder", "provider": "ollama",
     "context_window": 131072, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/qwen3", "provider": "ollama",
     "context_window": 262144, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": True, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/gemma3", "provider": "ollama",
     "context_window": 131072, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/phi4", "provider": "ollama",
     "context_window": 16384, "max_output": 8192,
     "supports_tools": False, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/mistral-nemo", "provider": "ollama",
     "context_window": 131072, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": False, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    {"id": "ollama/deepseek-r1", "provider": "ollama",
     "context_window": 65536, "max_output": 8192,
     "supports_tools": True, "supports_streaming": True, "supports_vision": False,
     "supports_thinking": True, "cost_per_mtok_input": 0.0, "cost_per_mtok_output": 0.0},
    # xAI direct
    {"id": "xai/grok-4", "provider": "xai",
     "context_window": 256000, "max_output": 16384,
     "supports_tools": True, "supports_streaming": True, "supports_vision": True,
     "supports_thinking": True, "cost_per_mtok_input": 5.0, "cost_per_mtok_output": 15.0},
    {"id": "xai/grok-3", "provider": "xai",
     ...
     "supports_thinking": True, "cost_per_mtok_input": 3.0, "cost_per_mtok_output": 15.0},
    # Cohere direct
    {"id": "cohere/command-a", "provider": "cohere",
