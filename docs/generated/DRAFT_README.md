> **DRAFT -- auto-generated, not manually verified.** Content below was produced
> by an AI documentation pass and has not been re-checked against the current
> source tree. Treat the authoritative README.md and GETTING_STARTED.md in the
> repo root as source of truth. Commands, module names, and directory listings
> here may be stale or aspirational.
